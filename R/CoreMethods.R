...
#' 
#' @param object an object of \code{SingleCellExperiment} class
#' @param distances vector contains items of "euclidean","pearson" or "spearman"
#' 
#' @return an object of \code{SingleCellExperiment} class
#' 
...
sc3_calc_dists.SingleCellExperiment <- function(object,distances) {
    dataset <- get_processed_dataset(object)
...
#' 
#' @param object an object of \code{SingleCellExperiment} class
#' @param transformations vector contains items of "pca" and "laplacian"
#' 
#' @return an object of \code{SingleCellExperiment} class
#' 
#' @importFrom doRNG %dorng%
...
#' @importFrom parallel makeCluster stopCluster
#' @importFrom doParallel registerDoParallel
sc3_calc_transfs.SingleCellExperiment <- function(object, transformations) {
