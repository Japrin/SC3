...
#' @export
setGeneric("sc3_calc_dists", signature = "object", function(object,distances=c("spearman")) {
    standardGeneric("sc3_calc_dists")
})

#' @export
setGeneric("sc3_calc_transfs", signature = "object", function(object,transformations=c("laplacian")) {
...
setGeneric("sc3_plot_markers", signature = "object", function(object, k, auroc = 0.85, 
                                        p.val = 0.01, show_pdata = NULL,plot.extra.par=list()) {
